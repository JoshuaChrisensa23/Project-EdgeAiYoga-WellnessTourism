  ...
  return (
    <div className="bg-gray-900 p-6 rounded-2xl shadow-xl flex flex-col justify-between border border-gray-800 h-fit space-y-4">
      <div>
        ...
        <div className="mb-6">
          <label className="text-sm font-medium text-gray-300 block mb-2">Pilih Target Pengujian Pose:</label>
          <select 
            value={selectedPose} 
          ...
          >
            ...
            <option value="WARRIOR_II">Warrior II Pose (Ekstensi Horizontal)</option>
            <option value="COBRA">Cobra Pose (Level Lantai)</option>
          </select>
        </div>

        <h2 className="text-lg font-bold mb-4 text-gray-200">Matriks Hasil Evaluasi</h2>
